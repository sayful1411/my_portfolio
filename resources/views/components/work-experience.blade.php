<section id="about" class="hg e z">
    <div class="a">
        <div class="mb hd ca">
            <div class="bc df">
                <div class="vc fa sg gb">
                    <span class="dh mh _g lk ua"> ABOUT ME </span>
                    <h2 class="dh jh wg wj kk oa" style="line-height: 3.5rem"> {{ $aboutData->title }} </h2>
                </div>
            </div>
        </div>
        <div class="ca">
            <div class="bc pl/2 df" style="margin: 0 auto; text-align:center;">
                <p class="eh ug lh la"> I am a qualified and professional Laravel developer with two years of experience
                    in back-end development. Strong creative and analytical skills. Interested in growing and developing
                    skills by working with a team. </p>
                <div class="mb id" style="justify-content: center">
                    <a href="https://facebook.com/sayful.islam1411" class="fc sb sa td mb id kd xd ge lh ri qi vi"
                    ...
                    <a href="https://twitter.com/md_sayful_islam" class="fc sb sa td mb id kd xd ge lh ri qi vi"
                        aria-label="social-link" name="social-link">
                    ...
                    <a href="javascript:void(0)" class="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link"
                        name="social-link">
                        <svg width="19" height="14" viewBox="0 0 19 14" class="ye">
                            <path
                    ...
                    </a> <a href="https://www.linkedin.com/in/sayfulislam1411"
                        class="fc sb sa td mb id kd xd ge lh ri qi vi" aria-label="social-link" name="social-link">
    ...
    <div class="d q i/2 -translate-y-1/2">
        <svg width="60" height="120" viewBox="0 0 60 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <radialGradient id="paint0_radial_18:24" cx="0" cy="0" r="1"
                    gradientUnits="userSpaceOnUse" gradientTransform="translate(60) rotate(90) scale(120)">
...
<section id="education" class="ig oe e z">
            ...
            <div class="mb hd ca">
                <div class="bc df">
                    <div class="vc fa sg gb">
                        ...
                        <p class="eh _g lh">There are many variations of passages of Lorem Ipsum available but the
    ...
    <div>
        <span class="d q f ba">
            <svg width="455" height="1307" viewBox="0 0 455 1307" fill="none"
                ...
                <defs>
                    <linearGradient id="paint0_linear_0:1" x1="166.025" y1="0" x2="166.025"
                        y2="1060.35" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#4A6CF7" />
                        <stop offset="1" stop-color="#4A6CF7" stop-opacity="0" />
                    </linearGradient>
                    <linearGradient id="paint1_linear_0:1" x1="254.924" y1="0" x2="254.924"
                        y2="1060.35" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#4A6CF7" />
                        <stop offset="1" stop-color="#4A6CF7" stop-opacity="0" />
                    </linearGradient>
        ...
        <span class="d g k aa">
            <svg width="416" height="1453" viewBox="0 0 416 1453" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <linearGradient id="paint0_linear_0:1" x1="166.025" y1="0" x2="166.025"
                        y2="1030.82" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#4A6CF7" />
                        <stop offset="1" stop-color="#4A6CF7" stop-opacity="0" />
                    </linearGradient>
                    <linearGradient id="paint1_linear_0:1" x1="395.791" y1="0" x2="395.791"
                        y2="1060.35" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#4A6CF7" />
                        <stop offset="1" stop-color="#4A6CF7" stop-opacity="0" />
                    </linearGradient>
